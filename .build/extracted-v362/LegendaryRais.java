...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.6.2 CROSSPLAY STABILITY & ARMOR ASCENSION enabled. Grip rebuild + vanilla bow behavior + dual armor skills + low-end caps active.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 362) return;
        getConfig().set("config-version", 362);
        ...
        getConfig().set("armor.input.double-sneak-window-ms",550L);
        getConfig().set("armor.input.punch-arm-ms",4500L);
        saveConfig();
        getLogger().info("Migrated LegendaryRais config to v3.6.2 Crossplay Stability & Armor Ascension defaults.");
    }
