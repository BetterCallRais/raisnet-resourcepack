...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.3.0 LEGENDARY ARSENAL enabled. Premium Water Relics + Free-Gacha Arsenal registered.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 330) return;
        getConfig().set("config-version", 330);
        ...
        getLogger().info("Migrated LegendaryRais config to v3.3.0 Legendary Arsenal defaults.");
    }
    ...
    private ItemStack createSoulTideKatana(boolean menuCopy) {
    ...
    private ItemStack createLeviathanTrident(boolean menuCopy) {
    ...
    @EventHandler public void onTidewalkerQuit(PlayerQuitEvent event){restoreTidewalkerGravity(event.getPlayer());}
