...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.2.0 LEGENDARY ARSENAL enabled. Premium Water Relics + Free-Gacha Arsenal registered.");
    ...
    private void applyV300ConfigMigration() {
        ...
        getConfig().set("config-version", 320);
        ...
        getLogger().info("Migrated LegendaryRais config to v3.2.0 Legendary Arsenal defaults.");
    }
