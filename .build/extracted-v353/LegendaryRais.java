...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.5.3 FULL REFORGE enabled. Soul Tide + Leviathan locked; crossplay-safe arsenal + armor rig active.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 350) return;
        getConfig().set("config-version", 350);
        ...
        getLogger().info("Migrated LegendaryRais config to v3.5.3 Full Reforge defaults.");
    }
