...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.6.3 RESOURCE INTEGRITY HOTFIX enabled. Automatic legacy item migration + validated resource references active.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 363) return;
        getConfig().set("config-version", 363);
        ...
        saveConfig();
        getLogger().info("Migrated LegendaryRais config to v3.6.3 Resource Integrity Hotfix defaults.");
    }
