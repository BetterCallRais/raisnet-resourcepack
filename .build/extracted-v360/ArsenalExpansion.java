...
public final class ArsenalExpansion implements Listener, CommandExecutor, TabCompleter {
    ...
    private ItemStack createWeapon(String id){Material mat;String name,model;int cmd;List<String> lore;
        switch(id){
            case EMBERFALL->{mat=Material.NETHERITE_SWORD;name="§6§lEMBERFALL §c§lCLAYMORE";model="emberfall_claymore";cmd=EMBERFALL_CMD;lore=List.of("§7Free-Gacha Legendary • Forged volcanic greatsword • long tapered blade • ember spine.","","§6I §fBlazing Cleave §8• §7Right Click","§cII §fCinder Rush §8• §7Sneak + Left Click","§4III §fMeteor Breaker §8• §7Sneak + Right Click","","§6Passive §8• §fHeatbreaker §7• every 3 melee hits ignites an AOE burst.","§7Damage: §eLegendary Gacha §8≪ Premium Water");}
            case NOCTIS->{mat=Material.NETHERITE_SWORD;name="§5§lNOCTIS §8§lLONGSWORD";model="noctis_longsword";cmd=NOCTIS_CMD;lore=List.of("§7Free-Gacha Legendary • Eclipse knight longsword • narrow profile • void-forged edge.","","§5I §fShadow Step §8• §7Right Click","§dII §fNight Sever §8• §7Sneak + Left Click","§8III §fEclipse Lock §8• §7Sneak + Right Click","","§5Passive §8• §fExecution Mark §7• every 2 hits executes a shadow strike.","§7Damage: §eLegendary Gacha");}
            case STORMPIERCER->{mat=Material.BOW;name="§f§lSTORMPIERCER §b§lTEMPEST BOW";model="stormpiercer_recurve_bow";cmd=STORM_CMD;lore=List.of("§7Free-Gacha Legendary • Storm-forged recurve bow • real projectile combat • explosive arrows.","","§bI §fExplosive Arrow §8• §7Draw + shoot normally","§7Arrow meledak saat mengenai entity / block, tanpa menghancurkan block.","§fII §fThunder Volley §8• §7Sneak + Left Click","§9III §fTempest Mark §8• §7Sneak + Right Click","","§bPassive §8• §fStatic Charge §7• every skill cast charges the next lightning hit.","§7Basic shot memakai arrow seperti bow normal.");}
            case GAIA->{mat=Material.NETHERITE_SHOVEL;name="§2§lGAIA §a§lWAR SPEAR";model="gaia_war_spear";cmd=GAIA_CMD;lore=List.of("§7Free-Gacha Legendary • Ancient war spear • slim ash haft • leaf-shaped mythic blade.","","§2I §fRoot Thrust §8• §7Right Click","§aII §fStonewake §8• §7Sneak + Left Click","§6III §fEarthshatter Line §8• §7Sneak + Right Click","","§2Passive §8• §fAncient Bark §7• melee stacks grant guard and root burst.","§7Damage: §eLegendary Gacha");}
            case ASTRAL->{mat=Material.SHEARS;name="§d§lASTRAL §5§lTWIN DAGGERS";model="astral_twin_daggers";cmd=ASTRAL_CMD;lore=List.of("§7Free-Gacha Legendary • Twin rift daggers • mirrored crescent profile • astral edge.","","§dI §fRift Dash §8• §7Right Click","§fII §fStar Fang §8• §7Sneak + Left Click","§5III §fAstral Rend §8• §7Sneak + Right Click","","§dPassive §8• §fPhase Combo §7• every 4 melee hits blinks through the target.","§7Damage: §eLegendary Gacha");}
