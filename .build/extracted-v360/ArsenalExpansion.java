...
/**
 * v3.6.0 Elemental Elite: 3D Java armor overlays, real MAX_HEALTH, weapon passives, unique armor skills and Bedrock parity. The two premium water relics remain in LegendaryRais core
...
public final class ArsenalExpansion implements Listener, CommandExecutor, TabCompleter {
    ...
    public void armorSetRetaliation(EntityDamageByEntityEvent e){
        ...
        if(PHOENIX.equals(set)){
            ...
            try{p.addPotionEffect(new org.bukkit.potion.PotionEffect(org.bukkit.potion.PotionEffectType.ABSORPTION,70,2,true,false,false));}catch(Throwable ignored){}
    ...
    private double baseDamage(String id){
        return plugin.getConfig().getDouble("gacha."+cfg(id)+".base-hit",switch(id){
            case EMBERFALL->30.8;   // 70% of Leviathan 44
            case NOCTIS->26.6;      // 70% of Soul Tide 38
            case STORMPIERCER->26.6;
            case GAIA->28.0;
            default->26.6;
        });
    }
    ...
    private double damage(String id,int skill){
        ...
        double[] d={455.0,455.0,455.0}; // 650 water-tier * 0.70
