...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.6.0 ELEMENTAL ELITE enabled. Soul Tide + Leviathan locked; Fire/Void/Electro/Wind/Ice arsenal + elite armor system active.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 360) return;
        getConfig().set("config-version", 360);
        ...
        getConfig().set("gacha.emberfall.base-hit",30.8);
        getConfig().set("gacha.noctis.base-hit",26.6);
        getConfig().set("gacha.stormpiercer.base-hit",26.6);
        getConfig().set("gacha.gaia.base-hit",28.0);
        getConfig().set("gacha.astral.base-hit",26.6);
        for(String k:List.of("emberfall","noctis","stormpiercer","gaia","astral"))getConfig().set("gacha."+k+".damage",List.of(455.0,455.0,455.0));
        ...
        getConfig().set("gacha.stormpiercer.arrow-impact-damage",220.0);
        saveConfig();
        getLogger().info("Migrated LegendaryRais config to v3.6.0 Elemental Elite defaults.");
    }
