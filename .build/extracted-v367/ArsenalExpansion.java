...
/**
 * v3.6.7 Crossplay Waterfix QA50: 3D Java armor overlays, real MAX_HEALTH, weapon passives, unique armor skills and Bedrock parity. The two premium water relics remain in LegendaryRais core
...
public final class ArsenalExpansion implements Listener, CommandExecutor, TabCompleter {
    ...
    private ItemStack createArmorPiece(String set,String piece){
        ...
        m.getPersistentDataContainer().set(assetVersionKey,PersistentDataType.INTEGER,367);
        item.setItemMeta(m);
        return item;
    }
    ...
    private boolean applyHelmetMode(Player p,String mode){
        ...
        meta.getPersistentDataContainer().set(assetVersionKey,PersistentDataType.INTEGER,367);
    ...
    private ItemStack refreshLegendaryItem(ItemStack old){
        ...
        if(expansionWeapon(wid)){
            ...
            if(ver!=null&&ver>=367&&old.getType()==expected)return old;
    ...
    private String weaponId(ItemStack item){
        ...
        if(expansionWeapon(id)&&(ver==null||ver<367)){
