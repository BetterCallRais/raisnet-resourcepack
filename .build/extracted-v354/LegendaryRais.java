...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.5.4 VISUAL INTEGRITY enabled. Soul Tide + Leviathan locked; native armor assets + modern Geyser mappings expected.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 354) return;
        getConfig().set("config-version", 354);
        ...
        saveConfig();
        getLogger().info("Migrated LegendaryRais config to v3.5.4 Visual Integrity defaults.");
    }
