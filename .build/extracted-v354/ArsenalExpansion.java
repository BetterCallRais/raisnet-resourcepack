...
/**
 * v3.5.4 Visual Integrity: 3D Java armor overlays, real MAX_HEALTH, weapon passives, unique armor skills and Bedrock parity. The two premium water relics remain in LegendaryRais core
...
public final class ArsenalExpansion implements Listener, CommandExecutor, TabCompleter {
    ...
    private void openLegendMenu(Player p){
        ...
        inv.setItem(4,menuItem(Material.NETHER_STAR,"§d§lLEGENDARY ARSENAL §f§lV3.5.4",List.of(
