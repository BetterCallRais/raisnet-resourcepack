...
public final class ArsenalExpansion implements Listener, CommandExecutor {
    ...
    private final NamespacedKey weaponKey, armorSetKey, armorPieceKey;
    ...
    private ItemStack fxItem(String model,int cmd){ItemStack i=new ItemStack(Material.PAPER);ItemMeta m=i.getItemMeta();if(m==null)return i;try{m.setCustomModelData(cmd);}catch(Throwable ignored){}try{m.setItemModel(new NamespacedKey("legendaryrais",model));}catch(Throwable ignored){}i.setItemMeta(m);return i;}
