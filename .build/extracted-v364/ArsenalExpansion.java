...
/**
 * v3.6.4 Bedrock Rig & Visor: 3D Java armor overlays, real MAX_HEALTH, weapon passives, unique armor skills and Bedrock parity. The two premium water relics remain in LegendaryRais core
...
public final class ArsenalExpansion implements Listener, CommandExecutor, TabCompleter {
    ...
    private void openLegendMenu(Player p){
        ...
        inv.setItem(4,menuItem(Material.NETHER_STAR,"§d§lLEGENDARY ARSENAL §f§lV3.6.4",List.of(
    ...
    private boolean applyHelmetMode(Player p,String mode){
        ...
        try{meta.setItemModel(new NamespacedKey("legendaryv34","armor/"+set+"_helmet_"+suffix));}catch(Throwable ignored){}
        try{
        ...
        meta.getPersistentDataContainer().set(assetVersionKey,PersistentDataType.INTEGER,364);
    ...
    private ItemStack refreshLegendaryItem(ItemStack old){
        ...
        if(expansionWeapon(wid)){
            ...
            if(ver!=null&&ver>=364&&old.getType()==expected)return old;
    ...
    private String weaponId(ItemStack item){
        ...
        if(expansionWeapon(id)&&(ver==null||ver<364)){
