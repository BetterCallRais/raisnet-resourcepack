...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.6.4 BEDROCK RIG & VISOR enabled. Helmet open/closed modes + rebuilt Bedrock armor rig active.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 364) return;
        getConfig().set("config-version", 364);
        ...
        saveConfig();
        getLogger().info("Migrated LegendaryRais config to v3.6.4 Bedrock Rig & Visor defaults.");
    }
