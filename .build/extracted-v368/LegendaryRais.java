...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.6.8 CLEAN-ID RESTORE QA50 enabled. Restored Java water relic art + collision-free v368 item-model IDs + rebuilt Bedrock definitions active.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 368) return;
        getConfig().set("config-version", 368);
