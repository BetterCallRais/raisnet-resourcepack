...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.6.5 WEAPON RIG & ARMOR SKILL HOTFIX enabled. Centered Java grips + Bedrock hold animations + reliable armor Skill II active.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 365) return;
        getConfig().set("config-version", 365);
