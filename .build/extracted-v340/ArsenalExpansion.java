...
/**
 * v3.4 Ultimate Arsenal: 3D Java armor overlays, real MAX_HEALTH, weapon passives, unique armor skills and Bedrock parity. The two premium water relics remain in LegendaryRais core
...
public final class ArsenalExpansion implements Listener, CommandExecutor {
    ...
    private ItemStack createWeapon(String id){Material mat;String name,model;int cmd;List<String> lore;
        switch(id){
            ...
            case STORMPIERCER->{mat=Material.BOW;name="§f§lSTORMPIERCER §b§lRECURVE BOW";model="stormpiercer_recurve_bow";cmd=STORM_CMD;lore=List.of("§7Free-Gacha Legendary • Realistic recurve war bow built around a storm core.","","§bI §fWindshot §8• §7Right Click","§fII §fThunder Volley §8• §7Sneak + Left Click","§9III §fTempest Mark §8• §7Sneak + Right Click","","§bPassive §8• §fStatic Charge §7• every skill cast charges the next lightning hit.","§7Skill tidak membutuhkan arrow.");}
    ...
    private void syncLegendaryHealth(Player p){
        try{
            ...
            // Clean the old v3.4 setMaxHealth migration if it exists.
