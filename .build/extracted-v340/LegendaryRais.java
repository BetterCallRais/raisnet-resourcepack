...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.4.0 ULTIMATE ARSENAL enabled. Premium Water Relics locked + Ultimate Arsenal registered.");
    ...
    private void applyV300ConfigMigration() {
        ...
        getConfig().set("config-version", 340);
        ...
        getLogger().info("Migrated LegendaryRais config to v3.4.0 Ultimate Arsenal defaults.");
    }
