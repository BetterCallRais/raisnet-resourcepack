...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.6.1 PERFORMANCE ELITE enabled. Adaptive low-end FX + double-sneak armor punch + balanced legendary combat active.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 361) return;
        getConfig().set("config-version", 361);
        ...
        saveConfig();
        getLogger().info("Migrated LegendaryRais config to v3.6.1 Performance Elite defaults.");
    }
