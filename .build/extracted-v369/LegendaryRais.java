...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.6.9 ARMOR ASCENSION & WIND MOBILITY enabled. HD armor visual pass + reduced armor skill damage + Zephya ground Windburst leap active.");
    ...
    private void applyV300ConfigMigration() {
        ...
        getConfig().set("config-version", 369);
