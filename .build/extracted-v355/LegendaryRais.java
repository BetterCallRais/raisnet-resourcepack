...
public final class LegendaryRais extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("LegendaryRais v3.5.5 ART REBUILD enabled. Soul Tide + Leviathan locked; HD weapon silhouettes + stable native armor pipeline active.");
    ...
    private void applyV300ConfigMigration() {
        ...
        if (version >= 355) return;
        getConfig().set("config-version", 355);
        ...
        saveConfig();
        getLogger().info("Migrated LegendaryRais config to v3.5.5 Art Rebuild defaults.");
    }
